...
public class LearnRadioButton {
	...
	public void run() throws MalformedURLException {
		...
		boolean isSel = this.checkElementIsSelected(radioFemale);
		System.out.println("Female radio button is selected :"+isSel);
		...
		System.out.println("Type attribute value for female radio button is : "+typeattr);
		...
		boolean isEn = this.checkElementIsEnabled(radioYes);
		System.out.println("Yes option is enabled : " + isEn);

...
public class LearnHyperLink {
	...
	public void run() throws MalformedURLException {
		...
		System.out.println("Crio.Do page link is displayed "+ isdis);
		...
		System.out.println("Crio.Do page link is enabled "+ isen);
		...
		totalLinks = driver.findElements(By.partialLinkText("a"));
		...
		for(WebElement elem : totalLinks){
         ...
         System.out.println("Total number of visible links "+visible);
		 System.out.println("Total number of not visible links "+notvisible);

...
;	}
	...
	public void run() throws MalformedURLException, InterruptedException {
		 ...
		 */
		btnClickThisButton = driver.findElement(By.xpath("/html/body/div/a/button/p"));
		 ...
		 * TODO : Print the response
		 */
		boolean isen = this.checkElementIsEnabled(btnClickThisButton);
		...
		*/
		...
		System.out.println("The text on the button is :"+ label);
		...
		System.out.println("The color on the button is :"+ color);
		...
		System.out.println("The attribute value is :"+ attr);
		 ...
		 * TODO : Print the response
		 */
		btnRest = driver.findElement(By.xpath("/html/body/div/div[2]/a/button"));
		color = this.getColorOfElement(btnRest);
		System.out.println("Color of Reset buton is : "+ color);

...
public class LearnTextBox {
	...
	public void run() throws InterruptedException, MalformedURLException {
		 ...
		 * 
		 */
		txtEnteryourName = driver.findElement(By.xpath("/html/body/div/div/div[2]/div[2]/div[1]/input"));
		 ...
		 */
		this.enterText(txtEnteryourName, "TARUN");
		
		/**
		 * Step - 5 : 
		 * TODO : Retrieve/read and print the placeholder value of "Your nationality" textbox
		 */
		String ph = this.getPlaceHolderText(txtEnteryourName);
		System.out.print("The placehoder value is :"+ph);
		 ...
		 */
		txtWeightBefore = driver.findElement(By.xpath("/html/body/div/div/div[2]/div[2]/div[4]/input[2]"));
		boolean isen = this.checkElementIsEnabled(txtWeightBefore);
		System.out.println("The textbox is enabled :" + isen);
		...
		try{
			...
			System.out.println("You cannot enter value in disabled box");
		}
		/**
		 *  Step - 8 : 

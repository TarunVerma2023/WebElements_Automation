...
public class LearnCheckbox {
	...
	public void run() throws MalformedURLException {
		...
		boolean isdisQA = this.checkElementIsDisplayed(chkBoxQA);
		boolean isdisFDT = this.checkElementIsDisplayed(chkBoxFDT);
		boolean isdisBDT = this.checkElementIsDisplayed(chkBoxBDT);
		boolean isdisDSA = this.checkElementIsDisplayed(chkBoxDSA);

		// TODO: Print the response
		System.out.println("Checkbox QA is enabled" + isdisQA);
		System.out.println("Checkbox FDT is enabled" + isdisFDT);
		System.out.println("Checkbox BDT is enabled" + isdisBDT);
		System.out.println("Checkbox DSA is enabled" + isdisDSA);
		...
		System.out.println("Type attribute for FDT checkbox "+attrDSA);
		System.out.println("Value attribute for FDT checkbox "+attrvalDSA);		
		...
		boolean isSelected = this.checkElementIsDisplayed(chkBoxUnknown);
